...
Surface unresolved roster proposal packets in Dispatch. Candidate-only runs must reach Audit and Promote proposal preparation without waiting for mapped hard picks. Use the parsed run (roster-proposals needsAudit output) rather than hard count alone. Do not manufacture a decision or suppress a needs-evidence candidate as dry.
