<!-- pundits-run date=2026-08-27 hard=0 audit=pending promoted=false -->
<!-- morning Fallica: audit=ok promoted=true -->
...
`audit=ok` `promoted=true` (Fallica `texas-cfp-2026` no already in `calls.json`).
...
## Scout run 2026-08-27 PM (Grok Bot)

Thursday afternoon recapture. Search by event. Empty YES sides + Week 0. Did not restage Finebaum, Fallica, or the morning eight. Did not touch `data/`.

`audit=ok` `promoted=false` (empty Intake).
...
- unc-vs-tcu-2026 YES — no roster UNC winner. Finebaum NO not restaged.
- ncsu-at-uva-2026 — no roster SU. Wasserman/PFF third-person. Cover 3 Who Wins / LOCKS no extractable first-person. Stay off home.
- Empty YES (Clemson, Patriots, 49ers, Bills, Wisconsin) — no new roster away-team winner.
- Title stretches onto Lambeau not restaged. Eisen Seahawks opener still paraphrase. ESPN Week 1 grid still No Pick.
...
- 49ers-vs-rams-2026: YES empty. NO eisen, cowherd.
- bills-at-texans-2026: YES empty. NO cowherd.
- unc-vs-tcu-2026: YES empty. NO finebaum.
- wisconsin-vs-nd-2026: fully empty, stays off home.
- ncsu-at-uva-2026: fully empty, stays off home.
...
ready to promote 0 hard rows.

## Scout run 2026-08-27 evening (Grok Bot)

P0 empty YES + P1 Lambeau. No futures padding. Do-not-touch list not restaged. Did not touch `data/`.
...
- clemson-at-lsu-2026 YES — no roster Clemson winner. GameDay Baton Rouge is Sept 5. Tebow/Klatt/Fallica/McAfee weasels not restaged. Neuheisel desk off-roster.
- unc-vs-tcu-2026 YES — no roster UNC winner. Finebaum Dublin not restaged.
- patriots-at-seahawks-2026 YES — no roster Patriots winner. ESPN Week 1 grid still No Pick.
- 49ers-vs-rams-2026 YES — no roster 49ers winner.
- bills-at-texans-2026 YES — no roster Bills winner. Skip is Super Bowl, not Houston.
- wisconsin-vs-nd-2026 — no Lambeau SU. Title stretches not restaged. Stays off home.
...
## Scout run 2026-08-27 late (podcast-first)

Idle roster podcasts first: simmons, kanell, mcafee (Pat only), florio, simms, clark, adams. P0 empty YES + Lambeau. No Barstool. No new ids. Did not touch `data/`.
...
- simmons — NFC O/Us with Cousin Sal; Melbourne pressure talk, not 49ers SU. Still zero mapped Week 1.
- florio — Aug 26–27 PFT Live no Week 1 winner. Australia clip is travel.
- simms — Unbuttoned Aug 26 camp/stock. AFC East not restaged.
- clark — Pivot camp interviews. Patriots-miss-playoffs is futures.
- adams — RSS idle since Aug 14. Favorite Patriots game is Week 17 Broncos.
- kanell — LOCKS first-person is UNC-TCU under 47.5, not SU. Who Wins has no Kanell winner. Chip Patterson UNC ML is not kanell. Clemson-LSU CBS pages are 2025. ND is title, not Lambeau.
- mcafee — 50-burger not restaged. Pulling for Dabo is not SU. No Pat first-person on Dublin or Lambeau.
