...
- 2026-09-23 (weekly radar): No material change vs 2026-09-16. CFB board at Week 4 FBS consensus (continuation of already-logged surface). NFL `/nfl/board` still titled **NFL Week 1** with the same Sep 13–14 field-consensus slate (CHI at CAR through DEN at KC); no public Week 2/3 NFL board observed. `@predictedsports` still **8 followers** (fxtwitter). Threat stays **Medium**; partnership call unchanged. No Pundits roadmap change.
