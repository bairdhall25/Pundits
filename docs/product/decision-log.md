...
| Scout is a density engine: Coordinator plus Shows/X/News beats against homepage games. | A deterministic scorecard keeps every medium focused on the same qualified-event-density goal. | Accepted 2026-08-29 |
