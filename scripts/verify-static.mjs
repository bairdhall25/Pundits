...
assert.match(home, /Chris Simms/);
assert.match(home, /Mike Florio/);
assert.match(home, /Giants at Rams/);
...
const weekNfl2 = await readFile(path.join(out, "nfl/2026/week-2/index.html"), "utf8");
assert.match(weekNfl2, /data-page-type="week"/);
assert.match(weekNfl2, /who got them right/);
assert.match(weekNfl2, /Tracked Week 2 record: 15–16/);
assert.match(weekNfl2, /2 still open/);
assert.match(weekNfl2, /Giants at Rams/);
